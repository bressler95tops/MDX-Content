...
In this lesson you will learn the process for sharing the software that you've developed. Before you start, you must determine if you are even allowed to share the software. Your institution or funding agency will have software-sharing guidelines, which may limit the openness of the software itself. It's also important to consider when and where software should be shared, which roles are needed during the sharing process, and how to enable others to reuse, or maintain, the code.
...
<SingleFigure size='small' src="./images/clone/Module_4/new/image540.png" />

Imagine that you've been working on a piece of code and are approached by a potential new collaborator who wants to use your code in their project. What is the best way to share the code? By email? When should you share the code, and what should you include to ensure that the colleague can easily use it? Developing a plan for sharing before you start your project will save you time and effort later. 
...
Writing scientific code is often a dynamic and collaborative process in which multiple people contribute, resulting in the code evolving over time. In such projects, it is beneficial to develop open code within a public repository hosting platform such as GitHub, Bitbucket, GitLab, etc. from the beginning of a project. This ensures that all updates are shared openly on the web and can reach potential collaborators and users in near real-time.

### Archiving Open Code

Archiving ensures your scientific code is accessible for the long-term, and may satisfy archiving requirements from funding agencies and organizations. Long-term accessibility helps others to reproduce your results long after publication. Archiving alone does not promote continued development or collaboration; it is a static and long-term preservation of your software, not an evolution of it.
...
- Downloading and contributing to open software projects can be regulated by your organization's Information Technology (IT) security policies.

In contrast, if the software was created with government funding, some funding agencies may require the software to be openly shared.

### Deep dive: Software Management Plans (SMP)

What do we need to consider when it comes to sharing? Below is a list of what should be included in a software management plan: 

<MultiSlider>
  <SliderItem type="multi">
    ### What:
    
    Description of management, preservation, and release of software.
  </SliderItem>
  <SliderItem type="multi">
    ### When:
    
    The schedule for code archiving and sharing.
  </SliderItem>
  <SliderItem type="multi">
    ### Where:
  ...
  <SliderItem type="multi">
    ...
    Enable reuse of software by assigning a DOI, license, contribution guidelines, etc.
  </SliderItem>
  <SliderItem type="multi">
    ### Who:
...
<CustomTabs>
  <Tab eventKey="one" title="LEGAL CONCERNS">
    <p>Anyone writing research code and software should familiarize themselves with their organization's policies on sharing and publishing software. Funding agencies, federal or private, may have strict software openness requirements. In other cases, sharing software may not be allowed by the organization.</p>
  ...
  <Tab eventKey="two" title="SECURITY CONCERNS">
    ...
    <ul>
      <li>Does your organization's IT policy allow you to checkout the code you want to use on your machine?</li>
      <li>How reputable is the repository you want to contribute to?</li>
...
Are you funded by a grant? Read the original grant call to see if publishing your code is allowed or required, and check whether it has any language about software management or any conditions to publish your code. When in doubt, contact your organization for additional information.
...
- Does anybody in your organization have to approve the release? 
...
If you are writing scientific software for a project funded by the NASA Science Mission Directorate (SMD), then you must adhere to SMD's requirements:

<QuoteImage quote='Scientific software needed to validate the scientific conclusions of peer-reviewed manuscripts resulting from SMD-funded scientific activities shall become publicly available no later than the publication date of the corresponding peer-reviewed article. This includes software required to derive the findings communicated in figures, maps, and tables, as well as scientifically useful software from models and simulations.' byWho="NASA's Open-Source Science Guidance (pg. 15)" byWhoLink="https://assets.science.nasa.gov/content/dam/science/cds/open-science/SMD%20Open-Source%20Science%20Guidance%20v2.2%2020250205.pdf" bgImage="./images/clone/Module_4/new/codebg.jpg" />
...
<SingleFigure size='medium' src="./images/clone/Module_4/new/image197.png" />

Like data, code can be shared in many ways, like over email or on a personal website, but these methods are not recommended. So, where should you share your open code?
...
<SingleFigure size='small' src="./images/clone/Module_4/new/image332.png" />

- Develop your software on a public repository such as GitHub.
- Publish to a software repository used by common package managers to make the software easy for users to install (e.g. Anaconda, CRAN, PyPI).
- Present the software at conferences.
- Publish the software in a journal dedicated to open software (e.g. <i>JOSS</i>). 
...
<SingleFigure size='small' src="./images/clone/Module_4/new/image425.png" />
...
You may recall from Lesson 3 that assigning an appropriate license is necessary for others to know how to use your code.

As an example, here's how you can assign a license to a GitHub repository:
...
<SingleFigure size='small' src="./images/clone/Module_4/new/image78.jpg" />
...
4. Set the repository visibility to 'Public' by selecting this option below the repository description.
...
9.  Now we will get a DOI from the Zenodo application. Note that we are going to use [https://sandbox.zenodo.org/](https://sandbox.zenodo.org/) to do this. This offers all the same capabilities as [https://zenodo.org](https://zenodo.org/), except this is a testing site! Create a free account if you have not already.

**Part 2: Create an archived repository and affiliated DOI.**

1. Navigate to the [Zenodo GitHub page](https://sandbox.zenodo.org/account/settings/github/) and log in to Zenodo.<br/><SingleFigure size='large' src="./images/clone/Module_4/new/step-1.jpg" />
2.  Click on the button "Connect" to allow Zenodo to access your GitHub repositories.<br/><SingleFigure size='large' src="./images/clone/Module_4/new/step-2.jpg" />
3. Review the information about access permissions, then click "Authorize Zenodo."
4. Sync your GitHub with Zenodo by clicking 'Sync now' in the upper right corner.<br/><SingleFigure size='large' src="./images/clone/Module_4/new/step-4.jpg" />
5. To the right of the name of the repository you want to archive ("os-test"), toggle the button to On.<br/><SingleFigure size='large' src="./images/clone/Module_4/new/step-5.jpg" />
6. Click on the name of the repository.
7. Click the big green button that has "username/os-test."<br/><SingleFigure size='large' src="./images/clone/Module_4/new/step-7.jpg" />
8. Add a tag "test." You may have to create a new tag for "test" if prompted.
9. Scroll down and click the green "publish release" button.<br/><SingleFigure size='large' src="./images/clone/Module_4/new/step-9.jpg" /><br/>Your release should look something like the following:<br/><SingleFigure size='medium' src="./images/clone/Module_4/new/step-9-2.jpg" />
10. Navigate to the [Zenodo GitHub page](https://sandbox.zenodo.org/account/settings/github/) and click on your "os-test" repository.
11. Your DOI will now appear as the following.<br/><SingleFigure size='large' src="./images/clone/Module_4/new/step-11.jpg" /><br/>Zenodo archives your repository and issues a new DOI each time you create a new GitHub [release](https://docs.github.com/en/repositories/releasing-projects-on-github/about-releases). Follow the steps at "[Managing releases in a repository](https://docs.github.com/en/repositories/releasing-projects-on-github/managing-releases-in-a-repository)" to create a new one.

### Making it Easy to Cite Your Code

Information about how to cite the software can be added to your README or other documentation in your repository. Another useful step for making your repository citation information accessible is to add a CITATION file to the repository.
...
<SingleFigure size='medium' src="./images/clone/Module_4/new/image419.png"/>
...
<Definitions>
  <Definition title='Who will add the code to a public repository?'>
    <ul>
      <li>Uploading the code</li>
      <li>Assigning a license</li>
    </ul>
  </Definition>
  <Definition title='Who will take care of code documentation?'>
    <ul>
      <li>Writing a README</li>
      <li>Adding explanatory comments to the code</li>
    </ul>
  </Definition>
  <Definition title='Who will help with code reuse?'>
    <p>Adding CITATION, CONTRIBUTING, and CODE_OF_CONDUCT files</p>
  </Definition>
  <Definition title='Who will maintain the software (if applicable)?'>
    <ul>
      <li>Who will respond to community input (e.g. via GitHub issues)?</li>
      <li>Who will be responsible for making decisions about which code to add/update from other contributors? (e.g. via GitHub pull requests)</li>
    </ul>
  </Definition>
</Definitions>
...
- This will help users know if it will continue to be supported in the future, allowing them to make choices on whether to base ongoing work off your project.
...
<SimpleQuiz id="quiz-m4-l4-knowledge-check">
  <SingleChoice question="I don't need to share my code if I don't plan to continue developing it." answer='answer-2' isBool="true">
    <SingleAnswer text='True' id='answer-1'/>
    <SingleAnswer text='False' id='answer-2'/>
  </SingleChoice>
  <SingleChoice question="Adding code to a GitHub repository is sufficient for archiving my code." answer='answer-2' isBool="true">
    <SingleAnswer text='True' id='answer-1'/>
    <SingleAnswer text='False' id='answer-2'/>
  </SingleChoice>
  <SingleChoice question="Organization and government software-sharing policies follow a standard practice." answer='answer-2' isBool="true">
    <SingleAnswer text='True' id='answer-1'/>
    <SingleAnswer text='False' id='answer-2'/>
  </SingleChoice>
  <SingleChoice question="Publishing your software to a software repository used by common package managers makes it easier for users to install your software." answer='answer-1' isBool="true">
    <SingleAnswer text='True' id='answer-1'/>
    <SingleAnswer text='False' id='answer-2'/>
  </SingleChoice>
  <MultipleChoice question='Which, if any, of the following are ways you can help others to reuse your code?'>
    <MultipleAnswer text='Assign an appropriate license' id='answer-1' isAnswer='true'/>
    <MultipleAnswer text="Add a file named 'CONTRIBUTING' with contributor guidelines" id='answer-2' isAnswer='true'/>
    <MultipleAnswer text="Add a 'CITATION' file with citation information" id='answer-3' isAnswer='true'/>
  </MultipleChoice>
  <MultipleChoice question='Which of the following are roles that you should plan for when writing an SMP?'>
    <MultipleAnswer text='Who will help maintain the software' id='answer-1' isAnswer='true'/>
    <MultipleAnswer text='Who will create the repository and add the necessary files' id='answer-2' isAnswer='true'/>
    <MultipleAnswer text='Who will contribute to the software after it is shared' id='answer-3' isAnswer='false'/>
    <MultipleAnswer text='Who will add documentation to the software' id='answer-4' isAnswer='true'/>
  </MultipleChoice>
</SimpleQuiz>
