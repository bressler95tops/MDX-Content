...
<MultiSlider infinite={false}>
  <SliderItem>
    ...
    <SingleFigure size='small' src="./images/clone/Module_5/image4.jpeg"/>
  ...
  <SliderItem>
    ...
    <SingleFigure size='small' src="./images/clone/Module_5/image5.png"/>
  ...
  <SliderItem>
    ...
    <SingleFigure size='small' src="./images/clone/Module_5/image6.png"/>
...
<SingleFigure size='large' src="./images/clone/Module_5/thepracticeofopen.jpg"/>
...
<SingleFigure size='small' src="./images/clone/Module_5/image9.jpeg"/>
...
<SingleFigure size='small' src="./images/clone/Module_5/image10.jpeg" caption="Source: https://medium.com/pangeo/fake-it-until-you-make-it-reading-goes-netcdf4-data-on-aws-s3-as-zarr-for-rapid-data-access-61e33f8fe685" link="https://medium.com/pangeo/fake-it-until-you-make-it-reading-goes-netcdf4-data-on-aws-s3-as-zarr-for-rapid-data-access-61e33f8fe685"/>
...
<SingleFigure size='small' src="./images/clone/Module_5/image11.png" caption="Image credit: OpenStreetMap 2011, Ken Vermette. CC BY-SA 3.0"/>
...
<SingleFigure size='large' src="./images/clone/Module_5/image12.jpeg" caption="Source: https://medium.com/dataseries/mastering-matplotlib-part-1-a480109171e3" link="https://medium.com/dataseries/mastering-matplotlib-part-1-a480109171e3"/>
...
<SingleFigure size='full' src="./images/clone/Module_5/image13.jpeg" caption="Figure Credit: https://arxiv.org/abs/2208.11692" link="https://arxiv.org/abs/2208.11692"/>
...
<SingleFigure size='full' src="./images/clone/Module_5/image14.jpeg"/>
...
<SingleFigure size='small' src="./images/clone/Module_5/image15.png"/>
...
<SingleFigure size='full' src="./images/clone/Module_5/image16.jpeg"/>
...
<QuoteImage quote='There are many personal advantages of implementing open science principles across all stages of a research process' bgImage="./images/clone/Module_5/image23.jpeg" />
...
<LearnButton href="https://opensciency.github.io/sprint-content/open-results/lesson1-research-process-and-results.html#research-stages-and-open-result-table" text="CLICK TO LEARN"/>
...
<SimpleQuiz id="quiz-m5-l1-knowledge-check">
  <SingleChoice question='Which of the following may fit the definition of a "research object"?"' answer='answer-5'>
    <SingleAnswer text='Raw data' id='answer-1'/>
    <SingleAnswer text='Blog' id='answer-2'/>
    <SingleAnswer text='Proposal' id='answer-3'/>
    <SingleAnswer text='Code of Conduct' id='answer-4'/>
    <SingleAnswer text='All of the above' id='answer-5'/>
  </SingleChoice>
  <SingleChoice question='What are some of the key causes of the reproducibility crisis?' answer='answer-4'>
    <SingleAnswer text='Intermediate methods of research are often described informally or not at all.' id='answer-1'/>
    <SingleAnswer text='Intermediate data are often omitted entirely.' id='answer-2'/>
    <SingleAnswer text='We often only think about results at the time of publication.' id='answer-3'/>
