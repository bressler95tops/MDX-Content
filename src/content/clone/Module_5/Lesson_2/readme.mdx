...
<CustomTabs>
    <Tab eventKey="one" title="GENERIC">
      <ul>
    ...
    <Tab eventKey="two" title="DISCIPLINE-SPECIFIC">
      <ul>
...
<CustomTabs>
    <Tab eventKey="one" title="THE MATERIAL ITSELF">
      <ul>
    ...
    <Tab eventKey="two" title="THE ASSOCIATED WEBSITE / SERVER">
      <ul>
    ...
    <Tab eventKey="three" title="SOURCE RELIABILITY INDICATORS">
      <ul>
...
<MultiSlider infinite={false}>
  <SliderItem type="multi">
    ...
    <SingleFigure size='thumb' src="./images/clone/Module_5/image29.png"/>
...
<Resources>
  <Resource title="See this blog for general issue etiquette" buttonTitle="OPEN" link="https://www.w3.org/International/i18n-activity/guidelines/issues.html"/>
</Resources>
...
<LearnButton href="https://www.elsevier.com/editor/perk/plagiarism-complaints#0-introduction" text="CLICK TO LEARN"/>
...
<SingleFigure size='large' src="./images/clone/Module_5/image31.png" caption="Preprint Server (Cite only if journal publication not available)"/>

<SingleFigure size='large' src="./images/clone/Module_5/image32.png" caption="Source Publication (Always cite)"/>
...
<SingleFigure size='large' src="./images/clone/Module_5/image33.png" caption='Jin, H., et al. 2023, "Optical color of Type Ib and Ic supernovae and implications for their progenitors," ApJ, preprint, arXiv:2304.10670.'/>

---

<CustomTabs>
    <Tab eventKey="one" title="FOR MATERIAL THAT HAS A DOI">
    ...
    <Tab eventKey="two" title="FOR MATERIAL THAT DOES NOT HAVE A DOI">
    ...
    <Tab eventKey="three" title="FOR OTHER MATERIALS OR INTERACTIONS THAT WERE HELPFUL FOR YOUR RESEARCH">
      <ul>
...
<SimpleQuiz id="quiz-m5-l2-knowledge-check">
  <MultipleChoice question='Which of the following could be a source of open results?'>
    <MultipleAnswer text='Web searches' id='answer-1' isAnswer='true'/>
    <MultipleAnswer text='Papers accessed through a paid subscription' id='answer-2' isAnswer='false'/>
    <MultipleAnswer text='Materials made public after a 1-year exclusive-use/paid-subscription-only period' id='answer-3' isAnswer='true'/>
    <MultipleAnswer text='Repositories' id='answer-4' isAnswer='true'/>
    <MultipleAnswer text='Open access papers' id='answer-5' isAnswer='true'/>
  </MultipleChoice>
  <MultipleChoice question='Which of the following characteristics suggest that a particular paper / data set is more likely to be a credible Open Result?'>
    <MultipleAnswer text='The website lists its source of funding' id='answer-1' isAnswer='true'/>
    <MultipleAnswer text='The results are described in an associated peer-reviewer publication' id='answer-2' isAnswer='true'/>
    <MultipleAnswer text='Detailed documentation accompanies the data, including defined fields and parameters' id='answer-3' isAnswer='true'/>
    <MultipleAnswer text='Organization contact information is listed' id='answer-4' isAnswer='true'/>
    <MultipleAnswer text='The website was last updated in 2015' id='answer-5' isAnswer='false'/>
    <MultipleAnswer text='The webpage advertises open job positions with the funder' id='answer-6' isAnswer='false'/>
    <MultipleAnswer text='The author is an expert in the field' id='answer-7' isAnswer='true'/>
    <MultipleAnswer text="The webpage's URL ends in '.com'" id='answer-8' isAnswer='false'/>
    <MultipleAnswer text='The accompanying documentation states that on inspection, data that were obvious outliers were excluded from the following analysis' id='answer-9' isAnswer='false'/>
  </MultipleChoice>
</SimpleQuiz>
