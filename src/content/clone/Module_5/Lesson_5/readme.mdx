...
<SingleFigure size="medium" src='./images/clone/Module_5/image75.jpeg' caption='Image credit: NASA Earth Observatory/Lauren Dauphin.'/>
...
<CustomTabs>
    <Tab eventKey="one" title="LITERATURE REVIEWS">
    ...
    <Tab eventKey="two" title="SEARCHING FOR RELEVANT DATASETS AND SOFTWARE TOOLS">
    ...
    <Tab eventKey="three" title="LANGUAGE BARRIERS">
...
<CustomTabs>
    ...
    <Tab eventKey="two" title="RESULTS">
...
<SimpleQuiz id="quiz-m5-l5-knowledge-check">
  <SingleChoice question='It is a good idea to include plans in your OSDMP for making your results available in ways outside of traditional publishing, e.g. online blog posts or tutorials.' answer='answer-1' isBool={true}>
    <SingleAnswer text='True' id='answer-1'/>
    <SingleAnswer text='False' id='answer-2'/>
  </SingleChoice>
  <MultipleChoice question='Which of the following aspects of AI are considered as benefits?'>
    <MultipleAnswer text='Personalized journal article recommendations based on your discipline and interests' id='answer-1' isAnswer='true'/>
    <MultipleAnswer text='Recommendations for data and software relevant to your science project' id='answer-2' isAnswer='true'/>
    <MultipleAnswer text='Potential introduction of bias' id='answer-3' isAnswer='false'/>
    <MultipleAnswer text='Factual mistakes' id='answer-4' isAnswer='false'/>
    <MultipleAnswer text='Translation between languages' id='answer-5' isAnswer='true'/>
  </MultipleChoice>
  <SingleChoice question="Which of the following are steps you can take to share your open results online? Let's assume that, like the activity, you are sharing an interactive visualization." answer='answer-6'>
    <SingleAnswer text='Host your project in a public GitHub repository' id='answer-1'/>
    <SingleAnswer text='Assign an open license' id='answer-2'/>
    <SingleAnswer text='Add a code of conduct to the GitHub repository' id='answer-3'/>
    <SingleAnswer text='Add a user manual' id='answer-4'/>
    <SingleAnswer text='Release your project on public repositories that assign DOIs' id='answer-5'/>
...
<QuoteImage quote="Open Science is the principle and practice of making research products and processes available to all, while respecting diverse cultures, maintaining security and privacy, and fostering collaborations, reproducibility, and equity" byWho="https://open.science.gov/" byWhoLink="https://open.science.gov/" bgImage="./images/clone/Module_5/opensciencequote.jpg" />
...
<LearnButton href="https://nasa.github.io/Transform-to-Open-Science/" text="CLICK TO LEARN"/>
...
<Resources>
  <Resource title="TOPS website" buttonTitle="Click to Learn" link="https://nasa.github.io/Transform-to-Open-Science/"/>
  <Resource title="TOPS GitHub Discussion Forum" buttonTitle="Click to Learn" link="https://github.com/nasa/Transform-to-Open-Science/discussions"/>
</Resources>

### Learn more through online courses:

<Resources>
  <Resource title="OpenSciency" buttonTitle="Click to Learn" link="https://opensciency.github.io/sprint-content/"/>
  <Resource title="Open Science MOOC" buttonTitle="Click to Learn" link="https://opensciencemooc.eu/"/>
</Resources>

### Take your coding and data science skills to the next level!

<Resources>
  <Resource title="Carpentries" buttonTitle="Click to Learn" link="https://carpentries.org/"/>
</Resources>

### Read online guides and learn about ongoing open science community initiatives:

<Resources>
  <Resource title="The Turing Way" buttonTitle="Click to Learn" link="https://the-turing-way.netlify.app/index.html"/>
  <Resource title="Center for Open Science" buttonTitle="Click to Learn" link="https://www.cos.io/"/>
  <Resource title="Open Science NL" buttonTitle="Click to Learn" link="https://www.openscience.nl/en"/>
</Resources>
