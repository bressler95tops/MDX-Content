...
<SingleFigure size='medium' src="./images/clone/Module_5/turingwayillustration.jpg" caption="Image credit: The Turing Way project illustration by Scriberia. Zenodo."/>
...
<QuoteImage quote="&quot;Reproducibility is a researcher's ability to obtain the same results in a published article using the raw data and code used in the original study.&quot;" bgImage="./images/clone/Module_5/stoddenquote.jpg" byWho="Stodden (2015)"/>
...
<CustomTabs>
    <Tab eventKey="one" title='GROUP POWER DYNAMICS &amp; EQUITY (E.G. SENIORITY, SYSTEMS OF OPPRESSION)"'>
...
<SingleFigure size='large' src="./images/clone/Module_5/image53.jpeg" caption="The polarized image of the M87 black hole shadow as observed on 2017 April 11 by the EHT (left panel) and an image from the EHT Model Library with a MAD magnetic configuration (right pane), with a list of papers describing different sets of results."/>
...
<SimpleQuiz id="quiz-m5-l3-knowledge-check">
  <MultipleChoice question='Which of the following roles would be most appropriately credited with contributorship?'>
  ...
  <SingleChoice question='What is not an example of open research results?' answer='answer-3'>
    <SingleAnswer text='Open access papers' id='answer-1'/>
    <SingleAnswer text='Conference presentation' id='answer-2'/>
    <SingleAnswer text='Internal team meeting notes' id='answer-3'/>
    <SingleAnswer text='Regular reports shared online' id='answer-4'/>
    <SingleAnswer text='Poster at a workshop' id='answer-5'/>
    <SingleAnswer text='Blog post' id='answer-6'/>
    <SingleAnswer text='Computational notebook on GitHub' id='answer-7'/>
    <SingleAnswer text='Figure with a DOI (e.g, Zenodo or Figshare)' id='answer-8'/>
    <SingleAnswer text='Pre-print of a paper' id='answer-9'/>
  </SingleChoice>
</SimpleQuiz>
