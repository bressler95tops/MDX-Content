...
<SingleFigure size='full' src="./images/clone/Module_2/image28.png"/>
...
<CustomTabs>
    <Tab eventKey="one" title="Findable">
        ...
        - PIDs: Persistent IDentifiers (additional details in the following sections)
          ...
          - [Open Research and Contributor ID](https://orcid.org/) (ORCID) iD - A code that uniquely identifies authors and contributors of research products and scholarly communication.
    </Tab>
    ...
    <Tab eventKey="four" title="Reusable">
        ...
        - [Zenodo](https://zenodo.org/) is not a domain-specific repository, yet through compliance with DataCite's Metadata Schema, Zenodo's metadata meets one of the broadest cross-domain standards available.
    </Tab>
</CustomTabs>
...
<SimpleQuiz id="quiz-m2-l3-knowledge-check">
  ...
  <MultipleChoice question='Which of the following are examples of repositories?'>
    <MultipleAnswer text='Zenodo' id='answer-1' isAnswer='true'/>
    <MultipleAnswer text='Dataverse' id='answer-2' isAnswer='true'/>
    <MultipleAnswer text='Dryad' id='answer-3' isAnswer='true'/>
    <MultipleAnswer text='Google' id='answer-4' isAnswer='false'/>
  </MultipleChoice>
</SimpleQuiz>
