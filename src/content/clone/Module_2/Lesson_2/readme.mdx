...
<Definitions>
    <Definition title='Discovery'>
        <p>Tools for finding content to use in your research.</p>
    </Definition>
    <Definition title='Analysis'>
        <p>Tools to process your research output, e.g. tools for data analysis and visualization.</p>
    </Definition>
    <Definition title='Writing'>
        <p>Tools to produce content, such as Data Management Plans, presentations, and preprints.</p>
    </Definition>
    <Definition title='Publications'>
        <p>Tools to use for sharing and/or archiving research.</p>
    </Definition>
    <Definition title='Outreach'>
        <p>Tools to promote your research.</p>
    </Definition>
</Definitions>
...
<SingleFigure size='small' src="./images/clone/Module_2/m2orcidlogo.jpg"/>

 ORCID stands for an "Open Researcher and Contributor IDentifier" and is designed to provide professional information about a person. 
 
 ORCID iDs provide a free, nonproprietary numeric code that:
...
ORCID iDs are used to link researchers to their research and research-related outputs. It is a 16-digit number that uniquely identifies researchers and is integrated with certain organizations (like some publishers) that will add research products (such as a published paper) to an individual's ORCID profile. ORCID iDs are meant to last throughout one's career, and helps to avoid confusion when information about a researcher changes over time (e.g., career change or name change). (cite: [https://orcid.org/](https://orcid.org/))
...
For example, the DOI: [10.5067/TERRA-AQUA/CERES/EBAF-TOA_L3B004.1](https://doi.org/10.5067/TERRA-AQUA/CERES/EBAF-TOA_L3B004.1) will always resolve to a web page that explains what the CERES_EBAF-TOA_Edition4.1 dataset is and how to download it. (See the screenshot below if you’re curious what this dataset actually is!)

DOIs are provided and maintained by the International Organization for Standardization ([ISO](https://www.iso.org/home.html)): [https://www.doi.org/](https://www.doi.org/).

<SingleFigure size='small' src="./images/clone/Module_2/image18.png"/>

### Citations Using DOIs

<SingleFigure size='large' src="./images/clone/Module_2/image19.jpeg"/>

DOIs make citing research products easier and more useful.

Data repositories will typically instruct you on the exact way to cite their data, which includes the correct DOI. For example, let’s take a look at the CERES_EBAF-TOA_Edition4.1 dataset mentioned above. This is an [example from the Atmospheric Science Data Center’s (ASDC) website](https://asdc.larc.nasa.gov/project/CERES/CERES_EBAF-TOA_Edition4.1/citation).

### Activity 2.1: Find and Resolve a DOI

In this activity, you will search for a DOI for a dataset or piece of code that you use, and you will then use the DOI website to “resolve” the DOI name. "Resolving" means being taken to the information about the product designated by that particular DOI.

1. Find the DOI for a dataset or code you use often.
   1. This should be listed either in the citation file, or on the website where that data/code is published.
...
<SingleFigure size='large' src="./images/clone/Module_2/image22.png"/>
...
<CustomTabs>
    ...
    <Tab eventKey="two" title="Example 2">
        <p>A workshop planning committee collaboratively authors a paper that summarizes the results of a workshop. They collect the ORCID iDs of everyone who participated in the workshop, and include them in the paper. Finally, they publish in an academic journal that automatically assigns the paper a DOI.</p>
    </Tab>
...
- [GeneLab Working Group](https://www.nasa.gov/osdr-genelab-about/)
...
<CustomTabs>
    ...
    <Tab eventKey="two" title="Code">
        ...
        <p>Associated publications: How did others use this code?</p>
    </Tab>
    <Tab eventKey="three" title="Results">
        <p>Associated publications: What was the research process?</p>
        <p>Packages of data and code for regenerating results.</p>
    </Tab>
</CustomTabs>

### Repositories

Repositories are storage locations for data, results, code, and compiled software. They provide the most common way to share and find each of these components. In general, you want to use a long term repository that will independently host and store your data making sure that it is both shared and preserved. Different kinds of repositories serve different purposes. For example, Zenodo acts as an archiving repository for individual version releases of data, software, and publications.
...
Users should select repositories based on their needs. See the lessons in the rest of this module and Modules 3 through 5 for more details.
...
- From day 1, establish a plan for management, preservation, and release of data, code, and results.
- This plan is your blueprint for open science - refer to your plan often to ensure you succeed in your goal of openness.

We'll discuss each component (data, code, & results) when we cover each topic.

**Note: Many funding opportunities (e.g., NASA ROSES) require an OSDMP as part of your proposal. For more information on NASA Science Mission Directorate’s (SMD's) requirements, please [see NASA Guidance on Management Plans](https://science.nasa.gov/researchers/sara/faqs/osdmp/).
...
<SingleFigure size='large' src="./images/clone/Module_2/image24.png"/>
...
Software management plans describe how software and code will be managed, preserved, and released as part of the scientific process. This helps ensure transparency and reproducibility in the scientific process. Module 4 (Open Code) shares more details about the importance of sharing code as part of the scientific process.

General components of a software management plan:

- Description of the software or code.
- Repository(ies) and archive(s) in which software or code will be shared.
- Sharing guidelines.
...
- **UK Wellcome Trust**
    - [Outputs Management Plan](https://wellcome.org/grant-funding/guidance/how-complete-outputs-management-plan)
...
- Who has responsibility and/or authority for what happens with the data?
...
- The definition and purpose of persistent identifiers. The usefulness of ORCID iDs and DOIs in the scientific process.
...
<SimpleQuiz id="quiz-m2-l2-knowledge-check">
  <SingleChoice question='What can open science tools help with?' answer='answer-4'>
    <SingleAnswer text='Discovery' id='answer-1'/>
    <SingleAnswer text='Writing' id='answer-2'/>
    <SingleAnswer text='Outreach' id='answer-3'/>
    <SingleAnswer text='All of above' id='answer-4'/>
  </SingleChoice>
  <MultipleChoice question='Complete the statement: Good, clear Metadata _____.'>
    <MultipleAnswer text='Improves findability' id='answer-1' isAnswer='true'/>
    <MultipleAnswer text='Improves accessibility' id='answer-2' isAnswer='true'/>
    <MultipleAnswer text='Improves interoperability' id='answer-3' isAnswer='true'/>
    <MultipleAnswer text='Improves reusability' id='answer-4' isAnswer='true'/>
    <MultipleAnswer text='Is a waste of time' id='answer-5' isAnswer='false'/>
  </MultipleChoice>
  <MultipleChoice question='Which are the components of a Software Management Plan?'>
    <MultipleAnswer text='Description of the software' id='answer-1' isAnswer='true'/>
    <MultipleAnswer text='Repository(ies) in which software will be archived' id='answer-2' isAnswer='true'/>
    <MultipleAnswer text='Sharing guidelines' id='answer-3' isAnswer='true'/>
    <MultipleAnswer text='Personnel roles and responsibilities' id='answer-4' isAnswer='true'/>
    <MultipleAnswer text='Any community-specific information of note' id='answer-5' isAnswer='true'/>
    <MultipleAnswer text='Creating a logo' id='answer-6' isAnswer='false'/>
  </MultipleChoice>
</SimpleQuiz>
